    ...
    <div className="reservation-container">
      ...
      <div className="reservation-body">
        ...
        <div className="surcharge-body">
          {showing.is3dMovie && (
            <p className="reservation-surcharge">*3D movie +50 kr</p>
          )}
          {showing.durationInMinutes > 170 && (
            <p className="reservation-surcharge">*Long movie +50 kr</p>
          )}
          {seats.length < 5 && (
            <p className="reservation-surcharge">*Under 5 tickets +50kr</p>
          )}
          {seats.length >= 10 && (
